...
public class UmsMemberCouponController {
    ...
    public CommonResult<List<SmsCouponHistory>> listHistory(@RequestParam(required = false) Integer useStatus) {
    ...
    public CommonResult<List<SmsCouponHistoryDetail>> listCart(@PathVariable Integer type) {
        var cartPromotionItemList = cartItemService.listPromotion(memberService.getCurrentMember().getId(), null);
